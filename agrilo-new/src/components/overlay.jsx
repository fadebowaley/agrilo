...
function Overlay() {
  return (
    <div className="absolute w-[93%] md:w-[100%] inset-0 bg-[#1fa12e] opacity-0 group-hover:opacity-70 transition-opacity duration-300 flex items-center justify-center">
